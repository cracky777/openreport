...
import { Section, SubSection, Field, RangeInput } from '../controls';
import { parseFloatOrNull } from '../../../utils/input';
  ...
  return (
    <Section id="axes" title="Axes" sectionState={sections}>
      <AxisPart label="X axis" cfg={cfg} updateConfig={updateConfig} inputStyle={inputStyle}
        ...
        keys={{ show: 'showXAxis', showTitle: 'showXAxisTitle', title: 'xAxisTitle', fontSize: 'xAxisLabelFontSize', color: 'xAxisLabelColor', fontFamily: 'xAxisLabelFontFamily' }} />
      <AxisPart label="Y axis" cfg={cfg} updateConfig={updateConfig} inputStyle={inputStyle}
        ...
        keys={{ show: 'showYAxis', step: 'yAxisInterval', showTitle: 'showYAxisTitle', title: 'yAxisTitle', fontSize: 'yAxisLabelFontSize', color: 'yAxisLabelColor', fontFamily: 'yAxisLabelFontFamily' }} />
      {type === 'combo' && (
        <AxisPart label="Right Y axis" cfg={cfg} updateConfig={updateConfig} inputStyle={inputStyle}
          keys={{ show: 'showSecondaryAxis', step: 'secondaryYAxisInterval', showTitle: 'showSecondaryYAxisTitle', title: 'secondaryYAxisTitle', fontSize: 'secondaryYAxisLabelFontSize', color: 'secondaryYAxisLabelColor', fontFamily: 'secondaryYAxisLabelFontFamily' }} />
      )}
      {type === 'scatter' && (
