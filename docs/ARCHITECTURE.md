...
| **Data plane** | Bases externes des clients | Données analytiques brutes (Postgres / Redshift / Snowflake / Databricks / ClickHouse / MySQL / MSSQL / BigQuery / DuckDB). Interrogées en live ; **la donnée client reste chez le client**. |
...
flowchart TB
  ...
  EXT[("Bases externes des clients (data plane)<br/>Postgres / Redshift / Snowflake / Databricks / ClickHouse / MySQL / MSSQL / BigQuery / DuckDB")]
