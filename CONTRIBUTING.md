...
Open a [GitHub Issue](https://github.com/cracky777/openreport/issues) with:
...
Open a [GitHub Issue](https://github.com/cracky777/openreport/issues) with the `enhancement` label. Describe:
...
Open a discussion on [GitHub Issues](https://github.com/cracky777/openreport/issues) or reach out to the maintainer.
