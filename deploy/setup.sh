...
echo "  The first user to sign up becomes the admin automatically."
echo "  Open the site in your browser, click Sign up, and the account you"
echo "  create will be promoted to admin."
echo ""
echo "Next steps:"
